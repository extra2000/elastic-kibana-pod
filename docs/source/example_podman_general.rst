...
Before creating snapshots, make sure to configure your MinIO instance according to this Section.

Create IAM Policy
~~~~~~~~~~~~~~~~~

Create a policy named "``extra2000-es-readwrite``":
        ...
        "Statement": [
            {
                ...
                "Resource": "arn:aws:s3:::extra2000-es"
            },
            {
                "Effect": "Allow",
                "Action": [
...
* Access Key: ``extra2000-es-admin``
* Secret Key: ``abcde12345``
* Assign Policies: ``extra2000-es-readwrite``

.. warning::

    User ``extra2000-es-admin`` will be strictly used for login MinIO console and manage service accounts. DO NOT use it on Elasticsearch or any services. Instead, use it's service account.
...
Create Elasticsearch bucket named ``extra2000-es``.

...
.. code-block:: bash
    ...
    scp -r -P 22 secrets/certificate-bundle secrets/kibana-01.keystore secrets/elastic-ca.pem USER@KIBANA-01:extra2000/elastic-kibana-pod/deployment/examples/podman-elk/secrets/
